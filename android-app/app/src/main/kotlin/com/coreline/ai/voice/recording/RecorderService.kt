...
import com.coreline.ai.voice.MainActivity
import com.coreline.ai.voice.R
import com.coreline.ai.voice.AirVoiceApplication
...
import com.coreline.ai.voice.data.storage.AppStorageMonitor
...
class RecorderService : Service() {
    ...
    private fun notification(status: String): Notification {
        ...
        return NotificationCompat.Builder(this, AirVoiceApplication.RECORDING_CHANNEL)
    ...
    companion object {
        const val ACTION_START = "com.coreline.ai.voice.action.START"
        const val ACTION_STOP = "com.coreline.ai.voice.action.STOP"
