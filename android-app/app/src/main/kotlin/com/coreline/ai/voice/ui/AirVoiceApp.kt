...
fun AirVoiceApp(
    ...
    AirVoiceTheme(darkTheme = darkTheme) {
    ...
    Box(
        ...
        Column(
            ...
            Text(
                ...
                color = com.coreline.ai.voice.ui.theme.ArchivePaper,
            )
            Spacer(Modifier.height(10.dp))
            Text(
                body,
                style = MaterialTheme.typography.bodyLarge,
                color = com.coreline.ai.voice.ui.theme.ArchiveFog,
            )
